        ...
        <div id="terms-and-conditions">
            ...
            <main className="max-width">
                ...
                <ul>
                    ...
                    <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to HigherorLower.co.uk.</li>
                ...
                <p>If you have any questions about these Terms and Conditions, You can contact us by sending an email to hi@higherorlower.co.uk.</p>
            </main>
        </div>
    )
}